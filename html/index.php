    ...
    <div class="table-responsive-vertical shadow-z-1">
	      ...
	      <?php
	        ...
	        while($entryName=readdir($myDirectory)) {
				...
				if (strpos($entryName,'.html') !== false && strpos($entryName,'index.php') === false ) {
				    $dirArray[]=$entryName;
				}		      
	        ...
	        for($index=0; $index < $indexCount; $index++) {
	          ...
	          $name_img = str_replace('html', 'png' , $name);
...
<br><br>
<small>
<h2 class="h5"><strong>Compatibilidad Navegadores</strong></h2>

<h3 class="h6"><strong>Mac & PC</strong></h3>
<ul>
	<li>Internet Explorer Windows 11</li>
	<li>Edge Windows</li>
	<li>Chrome (última versión)</li>
	<li>Firefox (última versión)</li>
	<li>Safari Mac (última versión)
</ul>
<h3 class="h6"><strong>Tablet</strong></h3>
<ul>
	<li>Safari iOS (última versión)</li>
	<li>Chrome Android (última versión)</li>
</ul>
<h3 class="h6"><strong>Móvil</strong></h3>
<ul>
	<li>Safari iOS (última versión)</li>
	<li>Chrome Android (4.4 y 5.0)</li>
</ul>
</small>
